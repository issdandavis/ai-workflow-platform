 ...
 * 
 * Complete database schema for the AI Workflow Platform.
 * Defines all tables, relationships, and types using Drizzle ORM.
 * 
 * @version 2.0.0
 * @adaptable true - Works with PostgreSQL (production) or SQLite (development)
 */
