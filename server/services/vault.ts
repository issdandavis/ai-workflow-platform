/**
 * Credential Vault v2.0
 * 
 * Secure encrypted storage for user API keys using AES-256-GCM.
 * Keys are encrypted at rest and decrypted only at moment of use.
 * 
 * @version 2.0.0
 * @adaptable true - Requires SESSION_SECRET for encryption, graceful error handling
 */
