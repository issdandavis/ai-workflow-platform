 ...
 * Ollama Client v2.0
 * 
 * Local Ollama integration for running AI models on your own hardware.
 * Completely free - no API keys needed, just run Ollama locally.
 * 
 * @version 2.0.0
 * @adaptable true - Checks health before requests, graceful fallback when unavailable
 */
