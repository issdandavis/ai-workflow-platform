/**
 * Figma MCP Client v2.0
 * 
 * Model Context Protocol client for Figma integration.
 * Enables AI-powered design operations via MCP.
 * 
 * @version 2.0.0
 * @adaptable true - Returns null when MCP endpoint not configured
 */
