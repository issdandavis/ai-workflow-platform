 ...
 * Stripe Client v2.0
 * 
 * Stripe payment integration for subscriptions and billing.
 * Supports products, prices, customers, and checkout sessions.
 * 
 * @version 2.0.0
 * @adaptable true - Gracefully handles missing Stripe credentials
 */
