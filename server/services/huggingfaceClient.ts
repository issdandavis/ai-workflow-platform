/**
 * HuggingFace Client v2.0
 * 
 * HuggingFace Inference API integration for free open-source model access.
 * Includes daily rate limiting (1000 requests/day) for fair usage.
 * 
 * @version 2.0.0
 * @adaptable true - Works without API key (uses free tier), handles rate limits gracefully
 */
