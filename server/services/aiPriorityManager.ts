/**
 * AI Priority Manager v2.0
 * 
 * Intelligent provider selection prioritizing free options over paid.
 * Priority order: FREE > YOUR_KEY > CREDITS (avoids Replit's paid integrations).
 * 
 * @version 2.0.0
