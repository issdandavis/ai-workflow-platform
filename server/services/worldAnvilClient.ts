/**
 * World Anvil Client v2.0
 * 
 * World Anvil API integration for worldbuilding content.
 * Supports worlds, articles, categories, maps, and timelines.
 * 
 * @version 2.0.0
 * @adaptable true - Gracefully handles missing WORLD_ANVIL_API_KEY
 */
