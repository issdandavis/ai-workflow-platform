 ...
 * Guide Agent v2.0
 * 
 * In-app AI assistant that helps users navigate and use the platform.
 * Can execute tools to manage projects, memory, integrations, and agents.
 * 
 * @version 2.0.0
 * @adaptable true - Uses Gemini by default, graceful fallback
 */
