/**
 * Shopify OAuth Authentication v2.0
 * 
 * OAuth 2.0 flow for Shopify app installation and authentication.
 * Handles authorization, callback, and session management.
 * 
 * @version 2.0.0
 * @adaptable true - Gracefully handles missing Shopify API credentials
 */
