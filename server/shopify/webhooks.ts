/**
 * Shopify Webhooks v2.0
 * 
 * Webhook handlers for Shopify events with HMAC verification.
 * Handles GDPR compliance webhooks and product events.
 * 
 * @version 2.0.0
 * @adaptable true - Gracefully handles missing webhook secret
 */
